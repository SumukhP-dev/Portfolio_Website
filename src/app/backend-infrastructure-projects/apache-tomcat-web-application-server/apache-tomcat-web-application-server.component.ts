...
export class ApacheTomcatWebApplicationServerComponent {
  images = [
    '/images/backend-infrastructure-projects/apache-tomcat-web-application-server/start-page.jpg',
    '/images/backend-infrastructure-projects/apache-tomcat-web-application-server/requests-record-page-details.jpg',
